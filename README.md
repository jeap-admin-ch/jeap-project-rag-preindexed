...
- [Indexed content and security considerations](docs/indexed-content-and-security-considerations.md) -
  exactly what gets swept into the index (and what doesn't), and what to check before pointing a new
  publicly-reachable consumer at this image.
